...
const oauthConfig = {
    FACEBOOK: {
        APP_ID: process.env.FB_APP_ID || '123',
        APP_SECRET: process.env.FB_APP_SECRET || '123',
        REDIRECT_URL: process.env.FB_REDIRECT_URL || '123'
    },
    GOOGLE: {
        APP_ID: process.env.G_ID || '123',
        APP_SECRET: process.env.G_SECRET_KEY || '123',
        REDIRECT_URL: process.env.FB_REDIRECT_URL || '123'
    }
};
